...
-- layouts.
--
-- THIS IS THE VERSION FROM THE VIMonad Fork of XMonad
--
--
-----------------------------------------------------------------------------
...
instance Default SubTheme where
    def = SubTheme { winActiveColor = "#999999"
                   , winActiveBorderColor = "#FFFFFF"
                   , winActiveTextColor = "#FFFFFF"
                   , winInactiveColor = "#666666"
                   , winInactiveBorderColor = "#BBBBBB"
                   , winInactiveTextColor = "#BFBFBF"
                   , winTitleAddons = []
                   , winTitleIcons = []
                   }
